...
write.table(fc_matrix, file = "LibSize_fc_matrixS11_1_0.05.csv",
            sep = "\t", row.names = F)



case <- read.csv('~/Desktop/NormWithPLS/NewCor/Results/LibSize_fc_matrixS11_1_0.05.csv', sep = '\t', header = TRUE)
##F-score
boxplot(summary(case[,3]), summary(case[,8]), summary(case[,13]), summary(case[,18]), summary(case[,23]), summary(case[,28]),
        # main = "Library Size",
        # names = c("Naive", "scL", "scran", "scn", "sct", "Pro"),
        names = c("Naive", "scK", "scran", "sct", "Psi", "Pro"),
        col=c("red", "purple", "green", "yellow", "orange", "blue"),
        # col=c("red", "purple", "green",  "orange", "blue"),
        outline = FALSE )

## bias
boxplot(summary(case[,4]), summary(case[,9]), summary(case[,14]), summary(case[,19]), summary(case[,24]), summary(case[,29]),
        # main = "Library Size",
        # names = c("Naive", "scL", "scran", "scn", "sct", "Pro"),
        names = c("Naive", "scK", "scran", "sct", "Psi", "Pro"),
        col=c("red", "purple", "green", "yellow", "orange", "blue"),
...
boxplot(summary(case[,1]), summary(case[,6]), summary(case[,11]), summary(case[,16]), summary(case[,21]), summary(case[,26]),
        # main = "Library Size",
        # names = c("Naive", "scL", "scran", "scn", "sct", "Pro"),
        names = c("Naive", "scK", "scran", "sct", "Psi", "Pro"),
        col=c("red", "purple", "green", "yellow", "orange", "blue"),
...
boxplot(summary(case[,2]), summary(case[,7]), summary(case[,12]), summary(case[,17]), summary(case[,22]), summary(case[,27]),
        # main = "Library Size",
        # names = c("Naive", "scL", "scran", "scn", "sct", "Pro"),
        names = c("Naive", "scK", "scran", "sct", "Psi", "Pro"),
        col=c("red", "purple", "green", "yellow", "orange", "blue"),
